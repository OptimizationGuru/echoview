...
const SideBar = () => {
  ...
  return (
    <div className="col-span-1 shadow-lg w-3/4 ">
      ...
      <div className="p-3 mx-1 mt-3 mb-1 ">
        <div className="py-2 px-3 text-xl font-medium flex hover:bg-gray-200 rounded-md">
          <p className="mx-1">You</p> <IconChevronRight stroke={2} />
        </div>
        <ul>
          <li className="my-1 text-xl py-2 px-3 flex hover:bg-gray-200 rounded-md">
            <div className="mx-2">
      ...
      <div className="p-3 mx-1 mt-3 mb-1 ">
        <div className="py-2 px-3 text-xl font-medium flex hover:bg-gray-200 rounded-md">
          <p className="mx-1">Subscriptions</p>
        </div>
        <ul>
          <li className="my-1 text-xl py-2 px-3 flex hover:bg-gray-200 rounded-md">
            <div className="mx-2">
        ...
        <div className='mx-2'>Your Videos</div>
          ...
          <li
            className="my-1 text-xl py-2 px-3 flex hover:bg-gray-200 rounded-md"
